...
bool cube::print_vetex(){
    ...
    std::string v = this->filename + "bar.1.node";
...
bool cube::print_ele(){
int index = 0;
std::string ele = this->filename + "bar.1.ele";
...
bool cube::print_face(){
    int index = 0;
    std::string facen = this->filename + "bar.1.face";
...
bool cube::print_boundary(){
    //top
    int index = 0;
    std::string facet = this->filename + "bar.1.top";
    ...
    //down
    index = 0;
    std::string faced = this->filename + "bar.1.down";
    ...
    //back
    index = 0;
    std::string faceb = this->filename + "bar.1.back";
    ...
    //front
    index = 0;
    std::string facef = this->filename + "bar.1.front";
    ...
    //left
    index = 0;
    std::string facel = this->filename + "bar.1.left";
    ...
    //right
    index = 0;
    std::string facer = this->filename + "bar.1.right";
